...
class forceReloadGame extends BaseCampaignEventListener implements EveryFrameScript
{
    private static final Logger Log = Logger.getLogger(forceReloadGame.class);
